        ...
        <div className="relative pb-4">
          ...
          >
            {media.map((item, i) => (
              <div
                key={i}
                className="relative shrink-0 w-[80vw] aspect-[4/3] rounded-xl overflow-hidden cursor-zoom-in"
              ...
              <div className="flex flex-col gap-2 shrink-0">
                {media.map((item, i) => (
                  <button key={i} onClick={() => setActiveIndex(i)}
                    className="relative w-[68px] aspect-square rounded-lg overflow-hidden transition-all duration-200 shrink-0"
