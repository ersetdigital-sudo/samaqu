                ...
                <div className="space-y-3">
                  ...
                  {activeVariant.sizes.map((s, i) => (
                    <div key={i} className="flex items-center gap-3 flex-wrap">
                      ...
                      <input value={s.priceOverride} onChange={(e) => updateSizeField(activeColor!, i, "priceOverride", e.target.value)} placeholder="Harga override" className="w-32 rounded-lg px-3 py-2 text-sm outline-none" style={{ border: "1px solid rgba(64,50,37,.15)", background: "white", color: "var(--espresso)" }} />
