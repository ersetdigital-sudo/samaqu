...
export default function WhatsAppFloat() {
  return (
    <a
      ...
      className="fixed bottom-5 right-5 z-50 inline-flex items-center gap-2.5 rounded-full px-5 py-3.5 text-white transition-all duration-300 hover:scale-105 hover:shadow-lg group"
      style={{
