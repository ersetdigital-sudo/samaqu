  ...
  return (
    <div style={{ background: "#f5f1ea" }} className="akun-root min-h-screen pb-40 md:pb-24">
      <div className="md:flex md:min-h-screen">
        {/* ── Sidebar (desktop) ── */}
        <aside className="hidden md:block md:w-64 md:shrink-0 md:sticky md:top-0 md:h-screen md:overflow-y-auto p-4">
          <div className="pt-4">
        ...
        {/* ── Content ── */}
        <main className="flex-1 min-w-0 px-4 pt-4 pb-10 md:px-10 md:pt-8 md:pb-12">
...
export function AkunHeader({ title, back }: { title: string; back?: string }) {
  ...
  return (
    <div className="akun-root sticky top-0 z-30 -mx-4 px-4 md:mx-0 md:px-0 md:static md:mb-6 bg-[#f5f1ea]/90 backdrop-blur md:bg-transparent md:backdrop-blur-0 flex items-center gap-3 pt-3 pb-4 md:pt-0 md:pb-0 border-b border-[#eae3d6] md:border-0">
      <button
        type="button"
